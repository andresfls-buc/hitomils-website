...
function extractPrice(price: string): object {
  ...
  if (!isNumeric) {
    return { "@type": "Offer", description: price, priceCurrency: "JPY" }
  }
  return {
    "@type": "Offer",
    price: numeric,
            ...
            {bridalServices.map((service) => (
              ...
              >
                ...
                <ul className="mt-6 space-y-2">
                  {service.includes.map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <Check
                        size={14}
                        className="text-[#B8A080] mt-0.5 shrink-0"
                      />
                      <span className="font-sans text-sm text-[#7A7570]">
                        {item}
                      </span>
                    </li>
                  ))}
                ...
                <div className="mt-8 pt-6 border-t border-[#EDD9D1]">
                  <p className="font-serif text-3xl text-[#2C2C2C]">
                    {service.price}
                  </p>
                  {service.priceNote && (
                    <p className="mt-1 font-sans text-xs text-[#7A7570]">
                      {service.priceNote}
                    </p>
                  )}
                </div>
          ...
          <div className="mt-12 max-w-2xl">
            ...
            <div className="mt-10 space-y-4 text-sm text-[#7A7570] font-sans leading-relaxed">
              <p>
                ...
                Cash (JPY) accepted on the day. Bank transfer available upon
                request.
              </p>
              <p>
                ...
                Full refund if cancelled 30+ days before the event. 50% charge
                for cancellations within 14 days.
              </p>
              <p>
                <span className="text-[#2C2C2C] font-medium">Travel:</span>{" "}
                Available for weddings across Hokkaido. Travel and accommodation
                costs apply for locations outside Sapporo.
              </p>
              <p>
                <span className="text-[#2C2C2C] font-medium">
                  Bridal bookings:
                </span>{" "}
                Please inquire at least 3 months in advance to secure your date.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col gap-6">
              <div className="border border-[#EDD9D1] p-6">
                ...
                <h3 className="font-serif text-2xl font-light text-[#2C2C2C]">
                  Total Beauty Bonita 手稲店
                </h3>
                <div className="mt-3 h-px w-10 bg-[#B8A080]" />
                <p className="mt-4 font-sans text-sm text-[#7A7570] leading-relaxed">
                  〒006-0021
                  <br />
                  藤川ビル 2階, 3 Chome-4-5 Teinehoncho 1 Jo
                  <br />
                  Teine Ward, Sapporo, Hokkaido
                </p>
              </div>
              <div className="overflow-hidden border border-[#EDD9D1]">
                <iframe
                  title="Total Beauty Bonita 手稲店"
                  src="https://maps.google.com/maps?q=3+Chome-4-5+Teinehoncho+1+Jo,+Teine+Ward,+Sapporo,+Hokkaido+006-0021&output=embed&z=16"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
            ...
            <div className="flex flex-col gap-6">
              <div className="border border-[#EDD9D1] p-6">
                ...
                <h3 className="font-serif text-2xl font-light text-[#2C2C2C]">
                  Total Beauty Bonita 発寒南店
                </h3>
                <div className="mt-3 h-px w-10 bg-[#B8A080]" />
                <p className="mt-4 font-sans text-sm text-[#7A7570] leading-relaxed">
                  〒063-0061
                  <br />
                  6 Chome-3-10 Nishimachikita
                  <br />
                  Nishi Ward, Sapporo, Hokkaido
                </p>
              </div>
              <div className="overflow-hidden border border-[#EDD9D1]">
                <iframe
                  title="Total Beauty Bonita 発寒南店"
                  src="https://maps.google.com/maps?q=6+Chome-3-10+Nishimachikita,+Nishi+Ward,+Sapporo,+Hokkaido+063-0061&output=embed&z=16"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
